const request = {
    fetchTrending:`trending/all/week?api_key=${process.env.REACT_APP_API_KEY}&language=en-IN`,
    fetchNetflixOriginals:`discover/tv?api_key=${process.env.REACT_APP_API_KEY}&with_network=213`,
    fetchTopRated : `movie/top_rated?api_key=${process.env.REACT_APP_API_KEY}&language=en-IN`,
