    ...
    <>
      ...
      <div className='movieInfo'>
        ...
        <div className='movieInfo__content'>
          ...
          <h1>Overview</h1>
          <h1 className='movieInfo__description'>{data.overview ? data.overview : ''}</h1>
          <div className='buttons'>
            <button className='btns' onClick={ ()  => handleClick(data)}>
              <h3 className='btn__text'><i className="fa fa-play"/>Play Trailer</h3>
            </button>
          </div>
        </div>
      </div>
      {trailerUrl && <div className='movie__trailer'>
        <div className='div__btn'>
          ...
          <button className='close__btn' onClick={ ()  => handleClick(data)} ><i className="fa fa-close"/></button>
        </div>
